    ...
    data(){
        return{
            ...
            itemOptions:[
                ...
                { id: 2, title: "项目名称", type: "text", key: "projectName", width:'150'},
                { id: 3, title: "项目CODE", type: "text", key: "projectCode", width:'150' },
                { id: 4, title: "项目类型", type: "text", key: "projectType", width:'100' },
                { id: 5, title: "项目阶段", type: "text", key: "projectStage", width:'100' },
                { id: 6, title: "项目创建时间", type: "text", key: "createTime", width:'179' },
                { id: 7, title: "计划周期", type: "text", key: "planCycle", width:'200' },
                { id: 8, title: "实际周期", type: "text", key: "actualCycle", width:'200' },
                { id: 9, title: "项目进度", type: "text", key: "projectProgress", width:'200' },
                { id: 10, title: "项目经理", type: "text", key: "projectBD", width:'100' },
                { id: 11, title: "客户名称", type: "text", key: "customer", width:'100' },
                { id: 12, title: "所属BD", type: "text", key: "projectManager", width:'100' },
            ],
            // 点击查询按钮提交的参数
            searchBtnSubmit:{
                projectName: '',
